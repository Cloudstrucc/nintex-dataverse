...
| **Environment ID** | [FILL] |
| **URL** | <https://dev-broker.crm3.dynamics.com> |
...
| **Environment ID** | [FILL] |
| **URL** | <https://prod-broker.crm3.dynamics.com> |
| **Region** | Canada Central |
...
|-------------|--------------|--------------|------------------------|
| Development | Sandbox | <https://sandbox.assuresign.net/v3.7> | dev-broker-kv/NintexAPIKey |
| QA | Sandbox | <https://sandbox.assuresign.net/v3.7> | qa-broker-kv/NintexAPIKey |
| Production | Production | <https://api.assuresign.net/v3.7> | prod-broker-kv/NintexAPIKey |
