...
var BROKER_ZIP = $"ESignatureBroker_1_0_0_40_{suffix}.zip";
...
switch (selChoice)
{
    ...
    case "5":
        ...
        Console.ForegroundColor = ConsoleColor.White;
        Console.Write($"    E-Signature Broker (v1.0.0.40) [Y/n]: ");
        Console.ResetColor();
...
if (installBroker)
{
    ...
    PrintSuccess($"Workflow solution ({BROKER_SOLUTION} v1.0.0.40) imported successfully");
    completedSolutions++;
    PrintOverallProgress(completedSolutions, totalSolutions);
}
